...
const mr = __importStar(require("./fp.js"));
/**
...
class MultiRange {
     ...
     */
    append(value) {
        this.ranges = mr.append(this.ranges, new MultiRange(value, this.options).ranges);
        return this;
    }
    /**
     ...
     */
    subtract(value) {
        this.ranges = mr.subtract(this.ranges, new MultiRange(value, this.options).ranges);
        return this;
    }
    /**
     ...
     */
    intersect(value) {
        this.ranges = mr.intersect(this.ranges, new MultiRange(value, this.options).ranges);
        return this;
    }
    /**
...
const multirange = (data, options) => new MultiRange(data, options);
exports.multirange = multirange;
